...
class AppStore extends Component {
  ...
  onChangingTab = () => {
    ...
    const filteredTab = appsList.filter(
      eachItem => eachItem.category === activeTab,
    )
    return filteredTab
  }

  clickButton = tabValue => {
  ...
  render() {
    const filteredTab = this.onChangingTab()
    const {activeTab, searchInput} = this.state

    const filtering = filteredTab.filter(eachItem => {
      return eachItem.appName
        .toLowerCase()
    ...
    return (
      <div className="main-container">
        <AppItem searching={this.onSearching} />
            ...
            return (
              <div className="div-container">
                <li className="images-container">
                  ...
                  />
                  <p className="content-name">{eachItem.appName}</p>
                </li>
              </div>
            )
          })}
